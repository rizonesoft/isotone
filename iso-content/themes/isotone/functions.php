<?php
/**
 * Glassmorphic Theme Functions
 * 
 * @package Glassmorphic
 * @version 1.0.0
 */

namespace GlassmorphicTheme;
...
function theme_setup() {
    ...
    $GLOBALS['glassmorphic_features'] = $theme_features;
    
    // Register navigation menus
    $GLOBALS['glassmorphic_menus'] = [
...
function get_theme_option($key, $default = null) {
    $options = get_option('glassmorphic_options', []);
...
function customize_register() {
    ...
    $GLOBALS['glassmorphic_customizer'] = [
        'glass_blur' => [
            'default' => '20px',
            'type' => 'select',
