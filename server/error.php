...
<head>
    ...
    <style>
        ...
        /* OPTIMIZATION 7: Removed unused RGB shift animation */
        ...
        /* All animations run at standard speed */
        /* Glitch effects are always enabled */
...
<body class="bg-gray-900 text-white min-h-screen flex items-center justify-center relative overflow-hidden scanlines">
    ...
    <script>
        ...
        // Random glitch trigger - always enabled but frequency adjusted
        ...
        function startGlitchEffect() {
            ...
            // Standard glitch frequency
            const glitchFrequency = 4000;
        ...
        const glitchDelay = 2000;
        const glitchStartTimer = setTimeout(startGlitchEffect, glitchDelay);
        ...
        // Multiverse console easter egg
        console.log('%c⟨ ISOTONE QUANTUM CONSOLE ⟩', 'font-size: 14px; color: #00d3f2; font-weight: bold; letter-spacing: 2px;');
        console.log('%c<?php echo $config['system_error']; ?>', 'color: #ff00ff; font-family: monospace;');
        console.log('%cReality branch #<?php echo $error_code; ?> detected', 'color: #00ffff; font-family: monospace;');
        console.log('%c→ Try shifting to an adjacent reality using the portal above', 'color: #00d3f2; font-family: monospace;');
