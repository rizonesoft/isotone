...
<div class="max-w-4xl">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-semibold"><?php echo $isNew ? 'Add New User' : 'Edit User'; ?></h1>
        <a href="/isotone/iso-admin/users.php" 
           class="inline-flex items-center px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded transition-colors">
    ...
    <form method="POST" class="bg-gray-800 rounded-lg border border-gray-700 p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       required
                       class="w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded focus:border-cyan-500 focus:outline-none">
        ...
        <div class="mt-6">
            ...
            <textarea id="bio" 
                      name="bio"
                      rows="4"
                      class="w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded focus:border-cyan-500 focus:outline-none"><?php echo htmlspecialchars($userData['bio'] ?? ''); ?></textarea>
        </div>
