...
class HooksCommand
{
    ...
    public function scan()
    {
        ...
        $jsonFile = __DIR__ . '/../../iso-development/storage/hooks-scan.json';
        file_put_contents($jsonFile, json_encode($results, JSON_PRETTY_PRINT));
        echo "\nDetailed results saved to: iso-development/storage/hooks-scan.json\n";
    }
    ...
    public function validate()
    {
        ...
        $scanResults = json_decode(
            file_get_contents(__DIR__ . '/../../iso-development/storage/hooks-scan.json'),
            true
        );
