...
require_once dirname(dirname(__DIR__)) . '/iso-core/hooks.php';
...
if ($activeTheme && $activeTheme->setting_value) {
    $themeFunctions = dirname(dirname(__DIR__)) . '/iso-content/themes/' . $activeTheme->setting_value . '/functions.php';
...
// Load plugin hooks
$pluginsDir = dirname(dirname(__DIR__)) . '/iso-content/plugins';
...
$implementationData = [];
$implementationFile = dirname(__DIR__) . '/iso-development/storage/hooks-implementation.json';
...
$hookStats = null;
$statsFile = dirname(__DIR__) . '/iso-development/storage/hook-stats.json';
